...
| 67 | Clientes mobile antigos re-inserem como vivas as compras tombstonadas | Baixa | DOCUMENTADO | Janela de compatibilidade aceita (transitoria, auto-cura apos update; nuvem nao ressuscita). Decisao em apps/mobile/docs/decisions.md; coordenar rollout do 1.0.3 com o deploy do web. 2026-07-07. |
